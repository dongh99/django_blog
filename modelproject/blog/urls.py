...
urlpatterns = [
    ...
    path('comments_create/<int:id>', views.comments_create, name="comments_create"),
    path('comments_delete/<int:blog_id>/<int:comment_id>', views.comments_delete, name="comments_delete"),
]